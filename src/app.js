...
assert(process.env.SECURE_KEY, 'process.env.SECURE_KEY missing, make sure your env is configured correctly');
assert(process.env.SECURE_KEY.split(',').length === 2, 'process.env.SECURE_KEY format invalid');
